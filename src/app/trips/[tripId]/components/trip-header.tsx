  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col p-5 lg:order-1 lg:p-0 lg:mb-10">
        <h1 className="font-semibold text-xl lg:text-3xl text-primaryDarker dark:text-secondary-foreground">
          {trip.name}
        </h1>

        <div className="flex items-center gap-1 my-1">
          <ReactCountryFlag countryCode={trip.countryCode} svg />
          <p className="text-xs lg:text-base text-grayPrimary underline dark:text-grayLighter">
            {trip.location}
          </p>
        </div>
